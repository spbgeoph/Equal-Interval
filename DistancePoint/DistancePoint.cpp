...
// DistancePoint.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDistancePointApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDistancePointApp

CDistancePointApp::CDistancePointApp()
{
...
// Единственный объект CDistancePointApp

CDistancePointApp theApp;


// инициализация CDistancePointApp

BOOL CDistancePointApp::InitInstance()
{
